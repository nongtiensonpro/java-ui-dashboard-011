...
//        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        if(validateText()){
            boolean ketQua = khachHangController.themKhachHang(taoKhachHangMoi());
            if(ketQua){
                MsgBox.alert(this, "Bạn đã thêm khách hàng thành công !");
            }else{
                MsgBox.alert(this, "Bạn đã thêm khách hàng thất bại");
            }
        }
